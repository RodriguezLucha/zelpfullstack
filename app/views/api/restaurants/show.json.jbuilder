json.cache! ["restaurants_#{@restaurant.id}", @restaurant], expires_in: 1.year do
  json.restaurant do
    ...
    json.review_ids @restaurant.reviews.sort_by { |review| review.updated_at }.reverse.pluck(:id)
